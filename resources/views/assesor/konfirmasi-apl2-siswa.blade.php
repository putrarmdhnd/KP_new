        ...
        <div class="col-lg-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h3>Formulir APL-2</h3>
                </div>

                @foreach($siswa as $si)

                <div class="card-body">
                    <form method="post" action="{{ route('admin.konfirmasi_apl2') }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="row g-3 m-3">
                            ...
                            <div class="col-12">
                                <div class="col-6 ">
                                    <div class="form-group">
                                        <label class="fw-bold" for="id_assesor">Nama Assessor</label><br>
                                        @foreach($nama_assessor as $as)
                                        <input type="text" class="form-control my-input" name="" id="nama_assesor" value="{{ $as->nama }}" placeholder="" disabled />
                                        @endforeach
                                    </div>
                                </div>
                                <div class="col-6 ">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control my-input" name="nama_siswa" id="nama_siswa" value="{{ $si->nama_siswa }}" placeholder="" readonly />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 kode_13">
                                ...
                                <div class="mt-4 d-flex gap-5">
                                    <div class="col-md-3">
                                        <label class="" for="">Tanda Tangan Aseessor</label>
                                        <br />
                                        <div id="sig"></div>
                                        <br />
                                        <button id="clear" class="btn btn-danger btn-sm">Ulangi Tanda tangan</button>
                                        <textarea id="signature64" name="ttdAssesor" style="display: none;"></textarea>
                                    </div>
                                </div>
                        ...
                        <div class="card-footer float-end">
                            <input type="hidden" name="statusKonfirmasi" id="statusKonfirmasi" value="2">
                            <input type="hidden" name="idApl2" id="id" value="{{$si->id}}">
                    ...
                    <script>
                        ...
                        if (Array.isArray(siswa)) {
                            siswa.forEach(function($si) {

                                if ($si.status_kompeten == 1) {


                                    for (var i = 1; i <= 13; i++) {
                                        var checkboxes = document.querySelectorAll('.kode_' + i + ' input[type="checkbox"]');
                                        checkboxes.forEach(function(checkbox) {


                                            if (checkbox.value === "kompeten") {
                            ...
                            console.error("Error: siswa bukanlah sebuah array.");
                        }
                    </script>
                </div>
