...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-12">
            <h4 class="text-center fw-bold mt-5">"DATA LPK-1 UNTUK DI KONFIRMASI KOSONG"</h4>
        </div>
        @else
        <div class="col-12">
            ...
            <div class="card border-1" role="listitem" data-region="course-content" data-course-id="651">
                <div class="card-body pr-1 course-info-container" id="course-info-container-651-13">
                    <div class="d-flex align-items-start">
                        ...
                        <div class="col-4">
                            <div class="small">
                                <a href="#" onclick="openAndPrint('/admin/{{$data->nik}}/pdf-apl1'); return false;" class="btn btn-primary btn-card float-end">Unduh</a>
                            </div>
                        </div>
                    </div>
